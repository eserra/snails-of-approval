...
const navItems = [
  ...
  { href: "/admin/snails", label: "Snails", icon: "snail", adminOnly: false },
  { href: "/admin/emails", label: "Emails", icon: "M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75", adminOnly: false },
...
function NavIcon({ d }: { d: string }) {
  if (d === "snail") {
    return <SnailIcon size={20} className="flex-shrink-0" />;
  }
  return (
    ...
    <>
      ...
      {session?.user && (
        <div className="border-t border-gray-200 pt-4 mt-4">
          ...
          >
            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.169.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
            </svg>
            Account
          </Link>
          <button
    ...
    <>
      ...
      <aside className="hidden md:flex w-60 bg-white border-r border-gray-200 h-[calc(100vh-4rem)] sticky top-16 p-4 flex-col overflow-y-auto">
        <div className="mb-6 px-3 flex items-center gap-2">
          <SnailIcon size={16} className="text-gray-400" />
